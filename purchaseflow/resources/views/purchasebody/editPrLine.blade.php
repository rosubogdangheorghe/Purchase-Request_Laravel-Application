...
<div class="table-responsive">
    ...
    <hr>
    <form action="{{ url('purchasebody',$purchasebody->id) }}" method="POST" class="was-validated">
    ...
    <div>
        <div class="form-group">
            ...
            <input type="text" name="description" value = "{{ $purchasebody->description}}" class="form-control col mb-2 mr-sm-2" placeholder="description" id="description" required>
        </div>    
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" onchange=setTwoNumberDecimal() name="quantity" value="{{ $purchasebody->quantity }}" class="form-control col mb-2 mr-sm-2 " placeholder="0.00" id="quantity" min="0" step="0.01" required>
        </div>
        <br>
        <div class="form-group">
            <label for="unitPrice" class="mb-2 mr-sm-2">Unit Price:</label>
            <input type="number" onchange=setTwoNumberDecimal() name="unitPrice" value="{{ $purchasebody->unitPrice }}" class="form-control col mb-2 mr-sm-2" placeholder="0.00" id="unitPrice" min="0" step="0.01" required>
        </div>
        <div class="form-group">
