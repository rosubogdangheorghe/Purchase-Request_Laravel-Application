...
//Schema::create('purchasebody',function(Blueprint $table){
// 	$table->id();
...
//             $table->enum('budgted',['yes','no']);
//             $table->string('budgetLine');   
//             $table->timestamps();
//         });
// })

// Schema::create('purchaseheader', function (Blueprint $table) {
//             $table->id();
...
//             $table->enum('status',['issued','checked','approved','rejected','received']);
//             $table->timestamps();
//         });

// public function purchasebody() {
// 	return $this->hasMany(Purchasebody::class,'purchaseId','id');
//    }
